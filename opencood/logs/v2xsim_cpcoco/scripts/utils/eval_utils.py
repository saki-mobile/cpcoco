...
def eval_final_results(result_stat, save_path, infer_info=None):
    ...
    print('The Average Recall at IOU 0.3 is %.2f, '
          'The Average Recall at IOU 0.5 is %.2f, '
          'The Average Recall at IOU 0.7 is %.2f' % (sum(result_stat[0.3]['tp'])/result_stat[0.3]['gt'],
                                                    sum(result_stat[0.5]['tp'])/result_stat[0.5]['gt'], 
                                                    sum(result_stat[0.7]['tp'])/result_stat[0.7]['gt']))
